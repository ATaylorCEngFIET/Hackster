...
architecture behav of Mat2AXIvideo is 
    ...
    signal ret_V_reg_314 : STD_LOGIC_VECTOR (32 downto 0);
    ...
    signal tmp_data_V_fu_279_p5 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_data_V_1_load_A)) then
                AXI_video_strm_V_data_V_1_payload_A <= tmp_data_V_fu_279_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_data_V_1_load_B)) then
                AXI_video_strm_V_data_V_1_payload_B <= tmp_data_V_fu_279_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_255_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                axi_last_V_reg_337 <= axi_last_V_fu_270_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                exitcond_i_reg_328 <= exitcond_i_fu_255_p2;
    ...
    OUTPUT_STREAM_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_i_reg_328, ap_enable_reg_pp0_iter2, exitcond_i_reg_328_pp0_iter1_reg)
    begin
    ...
    axi_last_V_fu_270_p2 <= "1" when (tmp_3_cast_i_fu_266_p1 = ret_V_reg_314) else "0";
    exitcond1_i_fu_244_p2 <= "1" when (t_V_reg_207 = rows_V_reg_304) else "0";
    exitcond_i_fu_255_p2 <= "1" when (t_V_1_reg_218 = cols_V_reg_309) else "0";
    ...
    tmp_data_V_fu_279_p5 <= (((ap_const_lv8_FF & img_data_stream_2_V_dout) & img_data_stream_1_V_dout) & img_data_stream_0_V_dout);
end behav;
