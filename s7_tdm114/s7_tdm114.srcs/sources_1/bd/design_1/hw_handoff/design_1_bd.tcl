...
proc create_root_design { parentCell } {
  ...
  set ALI3_0 [ create_bd_intf_port -mode Master -vlnv avnet.com:interface:avnet_ali3_rtl:1.0 ALI3_0 ]
  ...
  set frame_valid_in_0 [ create_bd_port -dir I frame_valid_in_0 ]
  set line_valid_in_0 [ create_bd_port -dir I line_valid_in_0 ]
  set pclk_0 [ create_bd_port -dir I pclk_0 ]
  set pixel_in_0 [ create_bd_port -dir I -from 9 -to 0 pixel_in_0 ]
  ...
  # Create instance: CAM_interface_0, and set properties
  set CAM_interface_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:CAM_interface:1.0 CAM_interface_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT3_JITTER {760.246} \
   CONFIG.CLKOUT3_PHASE_ERROR {613.025} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {24} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLKOUT4_JITTER {760.246} \
   CONFIG.CLKOUT4_PHASE_ERROR {613.025} \
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {24} \
   CONFIG.CLKOUT4_USED {true} \
   CONFIG.CLKOUT5_JITTER {604.245} \
   CONFIG.CLKOUT5_PHASE_ERROR {613.025} \
   CONFIG.CLKOUT5_REQUESTED_OUT_FREQ {66} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_demosaic_0_m_axis_video] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net pixel_in_0_1 [get_bd_ports pixel_in_0] [get_bd_pins CAM_interface_0/pixel_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs v_demosaic_0/s_axi_CTRL/Reg] SEG_v_demosaic_0_Reg
