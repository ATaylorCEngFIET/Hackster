...
proc create_root_design { parentCell } {
  ...
  set audio_top_0 [ create_bd_cell -type ip -vlnv adiuvo:hls:audio_top:1.0 audio_top_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {11.904749} \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {56} \
  ...
  connect_bd_intf_net -intf_net audio_top_0_AudioB [get_bd_intf_pins audio_top_0/AudioB] [get_bd_intf_pins i2s_transmitter_0/s_axis_aud]
  connect_bd_intf_net -intf_net i2s_receiver_0_m_axis_aud [get_bd_intf_pins audio_top_0/AudioA] [get_bd_intf_pins i2s_receiver_0/m_axis_aud]
  ...
  connect_bd_net -net i2s_receiver_0_irq [get_bd_pins i2s_receiver_0/irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net i2s_receiver_0_lrclk_out [get_bd_ports lrclk_out_0] [get_bd_pins i2s_receiver_0/lrclk_out] [get_bd_pins i2s_transmitter_0/lrclk_in] [get_bd_pins ila_0/probe0]
  connect_bd_net -net i2s_receiver_0_sclk_out [get_bd_ports sclk_out_0] [get_bd_pins i2s_receiver_0/sclk_out] [get_bd_pins i2s_transmitter_0/sclk_in] [get_bd_pins ila_0/probe1]
  connect_bd_net -net i2s_transmitter_0_irq [get_bd_pins i2s_transmitter_0/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net i2s_transmitter_0_sdata_0_out [get_bd_ports sdata_0_out_0] [get_bd_pins i2s_transmitter_0/sdata_0_out] [get_bd_pins ila_0/probe3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins audio_top_0/ap_clk] [get_bd_pins i2s_receiver_0/m_axis_aud_aclk] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aclk] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aclk] [get_bd_pins i2s_transmitter_0/s_axis_aud_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_49M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1_0] [get_bd_pins i2s_receiver_0/aud_mclk] [get_bd_pins i2s_transmitter_0/aud_mclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net rst_ps7_0_49M_peripheral_aresetn [get_bd_pins audio_top_0/ap_rst_n] [get_bd_pins i2s_receiver_0/m_axis_aud_aresetn] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aresetn] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aresetn] [get_bd_pins i2s_transmitter_0/s_axis_aud_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn]
  connect_bd_net -net sdata_0_in_0_1 [get_bd_ports sdata_0_in_0] [get_bd_pins i2s_receiver_0/sdata_0_in] [get_bd_pins ila_0/probe2]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins i2s_receiver_0/aud_mrst] [get_bd_pins i2s_transmitter_0/aud_mrst] [get_bd_pins rst_ps7_0_49M/peripheral_reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins audio_top_0/ap_start] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs i2s_transmitter_0/s_axi_ctrl/Reg] SEG_i2s_transmitter_0_Reg
