...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"$ref_dir/../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/2ad9/hdl" \
       +incdir+"$ref_dir/../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/16a2/hdl/verilog" \
       +incdir+"$ref_dir/../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/856d/hdl" \
       +incdir+"$ref_dir/../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/d5eb/hdl" \
       +incdir+"../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/2ad9/hdl" \
       +incdir+"../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/16a2/hdl/verilog" \
       +incdir+"../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/856d/hdl" \
       +incdir+"../../../../Zed_FMC_HDMI.srcs/sources_1/bd/design_1/ipshared/d5eb/hdl"
}
