...
HD_PWD='C:/hdl_projects/block_compile/block_compile.runs/design_1_dvi2rgb_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dvi2rgb_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dvi2rgb_1_1.tcl
