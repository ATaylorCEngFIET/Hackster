...
HD_PWD='C:/hdl_projects/block_compile/block_compile.runs/design_1_ila_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ila_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ila_5_0.tcl
