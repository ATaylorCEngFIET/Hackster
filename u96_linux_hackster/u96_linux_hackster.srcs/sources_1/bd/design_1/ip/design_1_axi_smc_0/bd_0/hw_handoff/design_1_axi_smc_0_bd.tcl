...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x00000000A0001000} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_map_M00_ACLK [get_bd_pins clk_map/M00_ACLK] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins switchboards/m_sc_aclk]
  connect_bd_net -net clk_map_M00_ARESETN [get_bd_pins clk_map/M00_ARESETN] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins switchboards/m_sc_aresetn]
