...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set fan_out [ create_bd_port -dir O -from 0 -to 0 fan_out ]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports fan_out] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
