...
Sobel::Sobel(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_reg_grp_Filter2D_fu_52_ap_start );
    ...
    ap_CS_fsm = "01";
    ap_reg_grp_Filter2D_fu_52_ap_start = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, ap_reg_grp_Filter2D_fu_52_ap_start, "ap_reg_grp_Filter2D_fu_52_ap_start");
...
void Sobel::thread_grp_Filter2D_fu_52_ap_start() {
    grp_Filter2D_fu_52_ap_start = ap_reg_grp_Filter2D_fu_52_ap_start.read();
}
